...
class MetroAgi:
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List[Istasyon]]:
        ...
        ziyaret_edildi = {(baslangic, 0)}

        while kuyruk:
            mevcut, rota, aktarma_sayisi = kuyruk.popleft()
            ...
            for komsu, sure in mevcut.komsular:
                ...
                if (komsu,yeni_aktarma) not in ziyaret_edildi:
                    ziyaret_edildi.add((komsu,yeni_aktarma))
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        while pq:
            f_score, _, mevcut, rota, g_score = heapq.heappop(pq)
            ...
            for komsu, sure in mevcut.komsular:
                if komsu not in ziyaret_edildi:
                    ...
                    heapq.heappush(pq, (f_score, id(komsu), komsu, rota + [komsu], yeni_g_score))
